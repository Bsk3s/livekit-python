...
class DeepgramTTSService:
    ...
    async def _get_tts_instance(self, character: str) -> deepgram.TTS:
        ...
        if character not in self._tts_instances:
            ...
            self._tts_instances[character] = deepgram.TTS(
                ...
                http_session=http_session  # Provide our own session
            )
    ...
    async def synthesize_streaming(self, text: str, character: str) -> AsyncGenerator[rtc.AudioFrame, None]:
        ...
        tts_instance = await self._get_tts_instance(character)
    ...
    async def cleanup(self):
        """Clean up TTS instances and HTTP session"""
